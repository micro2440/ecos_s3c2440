...
//                      This is essentially a copy of yaffs4 with UTF8 encoded
//                      file names.
//
//####DESCRIPTIONEND####
//
...
//==========================================================================
// The following filenames are in Cyrillic and are UTF-8 encoded. 
//
...
#define FEE             "Спутник"
#define BAR             "Байконур"
#define BUNDY           "СергеЬй ПаЬвлович Королёв"
#define FUM             "Юрий Гагаринский"
#define DOO             "Константин Эдуардович Циолковский"
//#define FIE             "Федеральное космическое агентство России"
#define FIE             "Федеральное космическое"
#define FOE             "Валентин Петрович Глушко"

#define TINKY           "Восток"
#define LAALAA          "Восход"
#define NOONOO          "Салют"
#define DIPSY           "Космодром"
#define PO              "Лайка"

#define XXXX            "Гласность"
#define YYYY            "перестройка"
#define ZZZZ            "Калашникова"
#define WWWW            "матрёшка"
...
#define TINKY           "tinky"
#define LAALAA          "laalaa"
#define NOONOO          "noonoo"
#define DIPSY           "dipsy"
#define PO              "po"
...
void yaffs6_main( CYG_ADDRESS id )
{
    int err;
...
#ifdef CYGDBG_INFRA_DIAG_CHECK_STRINGS
    diag_printf("WARNING: CYGDBG_INFRA_DIAG_CHECK_STRINGS is defined, Cyrillic file names will not be printed.\n");
#else
    diag_printf("WARNING: Cyrillic file names printed in UTF-8 may not be readable in some environments.\n");
#endif
