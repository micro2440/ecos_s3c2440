...
#if (CYGNUM_HAL_ARM_MINI2440_CPU_CLOCK == 176000000)
#define M_MDIV      80                  // Fin=12.0MHz Fout=176.0MHz
#define M_PDIV      1
#define M_SDIV      1
#elif (CYGNUM_HAL_ARM_MINI2440_CPU_CLOCK == 180000000)
#define M_MDIV      82                  // Fin=12.0MHz Fout=180.0MHz
#define M_PDIV      1
#define M_SDIV      1
#elif (CYGNUM_HAL_ARM_MINI2440_CPU_CLOCK == 184000000)
#define M_MDIV      84                  // Fin=12.0MHz Fout=184.0MHz
#define M_PDIV      1
#define M_SDIV      1
#elif (CYGNUM_HAL_ARM_MINI2440_CPU_CLOCK == 192000000)
#define M_MDIV      88                  // Fin=12.0MHz Fout=192.0MHz
#define M_PDIV      1
#define M_SDIV      1
#elif (CYGNUM_HAL_ARM_MINI2440_CPU_CLOCK == 200000000)
#define M_MDIV      92                  // Fin=12.0MHz Fout=200.0MHz
#define M_PDIV      1
#define M_SDIV      1
#elif (CYGNUM_HAL_ARM_MINI2440_CPU_CLOCK == 400000000)
#define M_MDIV      92                  // Fin=12.0MHz Fout=400.0MHz
#define M_PDIV      1
#define M_SDIV      1
#elif (CYGNUM_HAL_ARM_MINI2440_CPU_CLOCK == 405000000)
#define M_MDIV      127                 // Fin=12.0MHz Fout=400.0MHz
#define M_PDIV      2
#define M_SDIV      1
#else
#error CYGNUM_HAL_ARM_MINI2440_CPU_CLOCK not set to the right value
#endif
...
#if defined(CYG_HAL_STARTUP_ROM) || defined(CYG_HAL_STARTUP_ROMRAM) || defined(CYG_HAL_STARTUP_QEMU) || defined(CYG_HAL_STARTUP_NAND)
...
// This macro represents the initial startup code for the platform        
        ...
        ldr     r0,=CLKDIVN     // Set ratios 1:2:8 for FCLK:HCLK:PCLK
        ldr     r1,=(5)
        str     r1,[r0]
		...
		// Configure MPLL
		ldr    r0,=UPLLCON			
		ldr    r1,=((U_M_MDIV<<12)+(U_M_PDIV<<4)+U_M_SDIV)	// Fin=12MHz,Fout=50MHz
		str    r1,[r0]
...
#define oNFSTAT 0x20
	...
	nand2:
        ...
        ldr     r2,=MINI2440_START_ADDR
        orr     sp,r1,r2		 
	
		//copy U-Boot to RAM
		ldr r0, =MINI2440_START_ADDR
		mov r1, #0x0	  
		mov r2, #0x30000 
		bl nand_read_ll   
		tst r0, #0x0
...
on_the_ram:
#endif  //endif CYG_HAL_STARTUP_NAND
