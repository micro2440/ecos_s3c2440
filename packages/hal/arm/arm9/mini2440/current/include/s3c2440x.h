#ifndef CYGONCE_MINI2440_H
#define CYGONCE_MINI2440_H
...
// Date:         2011-03-21
// Purpose:      MINI2440 platform specific support definitions
// Description: 
// Usage:        #include <cyg/hal/s3c2440x.h>
//
//####DESCRIPTIONEND####
//
//=============================================================================
...
#define MINI2440_SDRAM_REDBOOT		    0x80000
#define MINI2440_SDRAM_PHYS_SIZE			( 64*1024*1024 )


// 留出 512K 给 redboot使用，注意最后的 16K 是 mmu 数据表使用。
#define MINI2440_SDRAM_SIZE				( MINI2440_SDRAM_PHYS_SIZE - MINI2440_SDRAM_REDBOOT )
// 这是搬动ROM镜像的地址，应该成为RAM可用区的结束地址。
#define MINI2440_START_ADDR				(MINI2440_SDRAM_PHYS_BASE + MINI2440_SDRAM_SIZE)
...
// Internal clocks
#define FCLK CYGNUM_HAL_ARM_MINI2440_CPU_CLOCK
#define HCLK CYGNUM_HAL_ARM_MINI2440_BUS_CLOCK
#define PCLK CYGNUM_HAL_ARM_MINI2440_PERIPHERAL_CLOCK
...
#define NFCMD      0x4E000008  //NADD Flash command
...
#define NFSECC     0x4E000034  //NAND Flash ECC
