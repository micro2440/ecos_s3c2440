...
//        kbd_drvr.c
//
//        Agilent MINI2440 - keyboard driver
//
//==========================================================================
...
#define MINI2440_KBD_COLS 8
#define MINI2440_KBD_ROWS 12

static unsigned int KB_rowState[MINI2440_KBD_COLS];  // Last known state Row x Col

// Map MINI2440 row/col to [PC standard] scancodes
static const int scancode[MINI2440_KBD_ROWS][MINI2440_KBD_COLS] =
{
...
cyg_bool
mini2440_KeyboardInit(void)
{
    int i;

    for (i = 0; i < MINI2440_KBD_COLS;  i++) {
        KB_rowState[i] = 0;
    }
    KBFlags = 0;
