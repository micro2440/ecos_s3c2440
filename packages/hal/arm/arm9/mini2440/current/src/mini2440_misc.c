...
//      mini2440_misc.c
//
//      HAL misc board support code for ARM9/MINI2440
//
//==========================================================================
...
hal_mmu_init(void)
{
    unsigned long ttb_base = MINI2440_SDRAM_PHYS_BASE + MINI2440_SDRAM_PHYS_SIZE - ARM_FIRST_LEVEL_PAGE_TABLE_SIZE;
    unsigned long i;
    ...
    //   DM9000_BASE_ADDRESS:    0x20000000,  16K
...
static void port_init(void)
{
    ...
    //Signal : DM9000 nLED_4 nLED_2 nLED_1 nIRQ_PCMCIA EINT2 KBDINT EINT0
    //Setting: EINT7  Output Output Output    EINT3    EINT2 EINT1  EINT0
    //Binary :  10      01     01     01       10       10    10     10
    HAL_WRITE_UINT32(GPFCON, 0x95aa);
    ...
    //Binary :   00    00   00    11    10      01        01       01       11         11
    //-----------------------------------------------------------------------------------------
    //Ports  :    GPG5       GPG4    GPG3    GPG2    GPG1    GPG0
    //Signal : KBDSPIMISO LCD_PWREN EINT11 nSS_SPI IRQ_LAN IRQ_PCMCIA
    //Setting:  SPIMISO1  LCD_PWRDN EINT11   nSS0   EINT9    EINT8
    //Binary :     11         11      10      11     10       10
    HAL_WRITE_UINT32(GPGCON, 0x0395ffba);
    ...
    //*** EXTERN INTERRUPT SETTING
    //EINT7 ENABLE DM9000 INT
...
hal_clock_initialize(cyg_uint32 period)
{
    ...
    temp &= ~(0xff<<8);
    temp |= (CYGNUM_HAL_ARM_MINI2440_TIMER_PRESCALE<<8);
...
hal_delay_us(cyg_int32 usecs)
{
    ...
    cyg_uint32 wait_ticks = (((PCLK/100000)*usecs)/CYGNUM_HAL_ARM_MINI2440_TIMER_PRESCALE/2/10);
