...
/* This is for the eCos embedded RTOS. Since users probably chose eCos
 because of its low resource consumption, we can't rely on having the stdio
 functions available.
 The crc32() function is available, but under a slightly different name.
 */
#ifdef __ECOS__

#include <pkgconf/gfx_png.h>

#ifdef  CYGFUN_PNG_NO_READ
#  define PNG_NO_READ_SUPPORTED
#else
#  undef PNG_NO_READ_SUPPORTED
#endif

#ifdef  CYGFUN_PNG_NO_WRITE
#  define PNG_NO_WRITE_SUPPORTED
#else
#  undef PNG_NO_WRITE_SUPPORTED
#endif

#ifdef CYGFUN_PNG_WITH_STDIO
#  undef PNG_NO_CONSOLE_IO
#  undef PNG_NO_STDIO
#else
